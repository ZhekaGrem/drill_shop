...
Худі з принтами футболок «Ніжної Оксани». У PDF сім дизайнів, розгортки згенеровані для всіх;
у продажу шість — зелене худі («Зелена Рунічна») власник прибрав 2026-09-21: товар видалений
з бази фазою `purge`, текстура лежить у `3d/unused/textures/`. Біле («Білонька») того ж дня
теж видаляли, а тоді повернули новим товаром на той самий слаг.
Джерело — `3d/серія боб ніжна оксана /дизайни.pdf`
...
`bake-hoodie-print.mjs TOOLS_DIR "#1c1d1d" …`) і шести текстурах
`public/3d/textures/dril/hoodie-oksana-<дизайн>.webp` (WebP без втрат, разом 248 КБ), які
