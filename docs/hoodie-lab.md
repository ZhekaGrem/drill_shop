...
у продажу пʼять чорних — біле («Білонька») і зелене («Зелена Рунічна») власник прибрав
2026-09-21: товари видалені з бази фазою `purge`, їхні текстури лежать у `3d/unused/textures/`.
...
`bake-hoodie-print.mjs TOOLS_DIR "#1c1d1d" …`) і пʼяти текстурах
`public/3d/textures/dril/hoodie-oksana-<дизайн>.webp` (WebP без втрат, разом 194 КБ), які
