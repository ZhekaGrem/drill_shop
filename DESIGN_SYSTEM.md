...
поля. Варіанти ширини: `default` (1200), `narrow` (720 — юридичні сторінки й форми), `wide`.
...
афорданс «тут можна перейти». `md` = 44px, `sm` = 32px, `tone="light"` — для фото й темних
поверхонь. Раніше цей елемент існував трьома різними способами (гола іконка 24px, коло в
слайдері, стрілка в кнопці) — тому й не читався як одна мова.
