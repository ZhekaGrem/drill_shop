# Є.Дріл — магазин офіційного мерчу

> Next.js 16 / React 19 · TypeScript · Mantine · SCSS Modules
>
> **V3:** [аудит і план](docs/v3/plan.md) · [перевірки](docs/v3/validation.md). Редакційна вітрина, реальні фото колекцій та одна інтерактивна 3D-сцена.
> Перевірка тем: `node scripts/check-v3-appearance.mjs` (Node 24+).
...
**Shop** — це повнофункціональний e-commerce застосунок для продажу офіційного мерчу з:
