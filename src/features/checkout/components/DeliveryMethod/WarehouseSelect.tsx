  ...
  return (
    <div className={styles.warehouseSelect}>
      <Select
        ...
        // `limit` Mantine не застосовує сам - він передає його у фільтр і чекає,
        // що той обріже список. Без slice дропдаун монтує всі 7988 київських
        // точок і вішає вкладку на відкритті та скролі.
