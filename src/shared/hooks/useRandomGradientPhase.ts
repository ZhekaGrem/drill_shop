 ...
 * кожну кнопку, а до Mantine-кнопок через тему події не привʼяжеш. Заразом
 * працює для кнопок, що зʼявилися після рендеру: модалки, пагінація, підвантажені списки.
 *
