...
export const content = {
  ...
  home: {
    ...
    // Другий герой: колекція «Дріл» (16 дизайнів, набори «дріл 1» і «дріл 2»)
    hero2: {
      title: 'Щільний Дріл',
      description: 'Нова колекція «Дріл»: шістнадцять дизайнів на білому й чорному — обери свій',
    },
    // Тестовий герой-колекція: різнорідні 3D-предмети + перемикач із міні-фото
    heroTest: {
      title: 'Колекція (тест)',
      description: 'Різні предмети в одному герої: дизайни футболки, худі, вішак — гортай мініатюрами',
    },
    buttons: {
