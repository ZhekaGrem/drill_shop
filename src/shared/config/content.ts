...
export const content = {
  ...
  home: {
    hero: {
      ...
      description:
        'Є.Дріл — офіційний магазин мерчу Щільного Drill зі Львова. Футболки, худі, постери та аксесуари лімітованими тиражами, без перепродажу та fan-made копій. Носи своє.',
    },
    buttons: {
