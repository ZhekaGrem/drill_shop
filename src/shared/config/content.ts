...
export const content = {
  ...
  home: {
    ...
    trust: [
      { label: 'Нова Пошта', hint: 'Відправка за 3-7 днів' },
  ...
  // ===== СТОРІНКА РОЗДІЛУ «є. Поламав» (/polamav) =====
  polamav: {
    title: 'Поламав',
    description: 'Футболки й худі Поламава: кожен дизайн у 3D.',
    soon: 'Розділ скоро відкриється.',
  },

  // ===== НОВИНИ (дзвіночок у слоті хедера) =====
  news: {
    triggerLabel: 'Новини',
    triggerUnreadLabel: 'Новини, є нове',
    title: 'Новини',
    close: 'Закрити',
  },
