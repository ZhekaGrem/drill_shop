        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <strong>Товар</strong> — мерч (одяг, футболки, худі, постери, касети, аксесуари та інші вироби
                бренду), представлений у каталозі інтернет-магазину
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>Натискання кнопки "Замовити" на сайті</li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              3.1. Продавець зобовʼязується передати у власність Покупця Товар, а Покупець зобовʼязується
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Після оформлення замовлення Продавець звʼязується з Покупцем протягом <strong>24 годин</strong>{' '}
            ...
            <ul className={styles.list}>
              ...
              <li>Неможливості звʼязатися з Покупцем протягом 3 діб</li>
            ...
            <div className={styles.infoBox}>
              <strong>Важливо:</strong> Продавець зобовʼязується повідомити Покупця про неможливість виконання
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <strong>Укрпошта</strong> — до відділення звʼязку
              </li>
              <li>
                <strong>Інші перевізники</strong> — Міст Експрес, Meest Express (за домовленістю)
              </li>
            </ul>
            ...
            <p className={styles.textBlock}>При отриманні Товару Покупець зобовʼязаний:</p>
            <ol className={styles.list}>
              <li>Предʼявити документ, що посвідчує особу</li>
              <li>Перевірити цілісність упаковки</li>
              <li>Перевірити найменування, кількість та комплектність Товару відповідно до накладної</li>
              <li>Перевірити відповідність розміру, кольору та моделі</li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>Є офіційним мерчем бренду без fan-made копій та перепродажу</li>
              <li>Відповідає опису, розмірній сітці та фото у каталозі</li>
              <li>Не має виробничого браку тканини, друку або пошиття</li>
              <li>Упакований належним чином для транспортування</li>
            </ul>
            ...
            <ul className={styles.list}>
              ...
              <li>Інформація про склад тканини та рекомендації з догляду</li>
            </ul>

            <h3 className={styles.subsectionTitle}>7.3. Умови догляду</h3>
            <p className={styles.textBlock}>
              Після отримання Покупець зобовʼязаний дотримуватися рекомендацій з догляду, вказаних на етикетці
              виробу (температура прання, режим прасування). Продавець НЕ несе відповідальності за стан Товару
              при порушенні умов догляду Покупцем.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.blueAlert}>
              <strong>КОРОТКО:</strong> Відповідно до{' '}
              <strong>ст. 9 Закону України «Про захист прав споживачів»</strong>, Покупець має право повернути
              непоношений Товар належної якості протягом 14 днів з моменту отримання.
            </div>
            ...
            <p className={styles.textBlock}>
              ...
              <strong>14 календарних днів</strong> з моменту отримання за умови, що Товар непоношений, зберіг
              заводський вигляд, упаковку, етикетки та має товарну накладну.
            </p>
            ...
            <ol className={styles.list}>
              <li>Звʼязатися з Продавцем протягом 24 годин з моменту виявлення недоліку (email, телефон)</li>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>9. Права та обовʼязки сторін</h2>

            <h3 className={styles.subsectionTitle}>9.1. Продавець зобовʼязується</h3>
            <ul className={styles.list}>
            ...
            <h3 className={styles.subsectionTitle}>9.3. Покупець зобовʼязується</h3>
            <ul className={styles.list}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Відповідальність Продавця за неналежне виконання зобовʼязань обмежується вартістю конкретного
            ...
            <p className={styles.textBlock}>
              Сторони звільняються від відповідальності за невиконання зобовʼязань, якщо це сталося внаслідок
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>Продавець зобовʼязується:</p>
            <ul className={styles.list}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                <strong>Державної служби України з питань захисту прав споживачів</strong> (при виявленні
                проблем з якістю Товару)
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              ...
              виконання зобовʼязань сторонами.
            </p>
