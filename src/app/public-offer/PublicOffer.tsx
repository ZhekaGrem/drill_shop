        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                <strong>Товар</strong> — мерч (одяг, футболки, худі, постери, касети, аксесуари та інші
                вироби бренду), представлений у каталозі інтернет-магазину
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Після отримання Покупець зобов'язаний дотримуватися рекомендацій з догляду, вказаних на
              етикетці виробу (температура прання, режим прасування). Продавець НЕ несе відповідальності за
              стан Товару при порушенні умов догляду Покупцем.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.blueAlert}>
              <strong>КОРОТКО:</strong> Відповідно до <strong>ст. 9 Закону України «Про захист прав
              споживачів»</strong>, Покупець має право повернути непоношений Товар належної якості протягом
            ...
            <p className={styles.textBlock}>
              ...
              <strong>14 календарних днів</strong> з моменту отримання за умови, що Товар непоношений,
              зберіг заводський вигляд, упаковку, етикетки та має товарну накладну.
            </p>
