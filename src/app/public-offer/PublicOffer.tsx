        ...
        <div className={styles.content}>
          <section className={styles.section}>
            <p className={styles.textBlock}>
              Цей документ є офіційною публічною пропозицією (офертою) для укладення договору
              купівлі-продажу товарів дистанційним способом між Продавцем та Покупцем.
            </p>
            ...
            <div className={styles.orangeAlert}>
              <strong className={styles.boldText}>УВАГА:</strong> Оформлення замовлення на сайті означає
              ваше повне і беззастережне прийняття умов цього Договору (акцепт оферти). Якщо ви не згодні з
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              2.2. Моментом укладення Договору (акцептом оферти) вважається:
            </p>
            <ul className={styles.list}>
            ...
            <p className={styles.textBlock}>
              2.3. Укладаючи цей Договір, Покупець підтверджує, що:
            </p>
            <ul className={styles.list}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              3.2. Договір регулює відносини щодо:
            </p>
            <ul className={styles.list}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.infoBox}>
              <strong>Важливо:</strong> Продавець зобов'язується повідомити Покупця про неможливість
              виконання замовлення протягом 24 годин телефоном або email.
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>
                <strong>Готівка при отриманні</strong> — оплата готівкою або карткою у відділенні Нової
                Пошти. Комісія перевізника за накладений платіж сплачується Покупцем.
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Вартість доставки сплачується Покупцем за тарифами перевізника та НЕ входить у вартість
              Товару. Орієнтовні терміни доставки:
            </p>
            <ul className={styles.list}>
            ...
            <p className={styles.textBlock}>
              При отриманні Товару Покупець зобов'язаний:
            </p>
            ...
            <p className={styles.textBlock}>
              Ризик випадкового пошкодження або втрати Товару переходить до Покупця з моменту передачі
              Товару перевізнику (відповідно до <strong>ст. 668 ЦКУ</strong>).
            </p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.orangeAlert}>
              <strong>УВАГА:</strong> Відповідно до{' '}
              <strong>Постанови КМУ №1769 від 19.12.1994</strong> (зі змінами), продовольчі товари
              належної якості поверненню та обміну НЕ підлягають.
            </div>
            ...
            <p className={styles.textBlock}>
              Для повернення Товару неналежної якості Покупець повинен:
            </p>
            <ol className={styles.list}>
              <li>
                Зв'язатися з Продавцем протягом 24 годин з моменту виявлення недоліку (email, телефон)
              </li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              12.4. Покупець також має право звернутися до:
            </p>
            <ul className={styles.list}>
              <li>
