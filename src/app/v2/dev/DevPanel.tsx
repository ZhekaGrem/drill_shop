...
export const DevPanel = () => {
  ...
  const stateRows: [string, string][] = [
    ...
    ['Десктоп', 'відкритий на всіх публічних сторінках'],
    ['Перемикач теми', 'лише на цій сторінці; для покупців діє авто-правило активного дизайну'],
    ...
    [
      ...
      design === 'streetwear'
        ...
        : design === 'cupertino' || design === 'editorial'
          ? 'за системною темою пристрою'
