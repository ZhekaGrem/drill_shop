      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Детальна інформація про умови повернення та обміну продовольчих товарів відповідно до
        ...
        <div className={styles.content}>
          <div className={styles.redAlert}>
            <strong className={styles.boldText}>ВАЖЛИВА ІНФОРМАЦІЯ:</strong> Відповідно до Постанови
            Кабінету Міністрів України № 1769 від 19.12.1994 (зі змінами), продовольчі товари належної
            якості НЕ ПІДЛЯГАЮТЬ поверненню та обміну.
          </div>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>Закон України &quot;Про захист прав споживачів&quot; № 1023-XII від 12.05.1991</li>
              <li>Цивільний кодекс України № 435-IV від 16.01.2003 — ст. 678-680</li>
              <li>Постанова КМУ № 1769 від 19.12.1994</li>
              <li>Правила продажу продовольчих товарів (Наказ № 172 від 10.07.1995)</li>
            </ul>

            <div className={styles.infoBox}>
              М&apos;ясні вироби входять до Переліку товарів належної якості, що не підлягають обміну
              (поверненню).
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <h3 className={styles.subsectionTitle}>2.1. Заборона на повернення</h3>
            <p className={styles.textBlock}>
              Якщо товар належної якості (без дефектів), покупець НЕ МОЖЕ:
            </p>
            <ul className={styles.list}>
            ...
            <div className={styles.orangeAlert}>
              <strong>УВАГА:</strong> Це правило діє навіть якщо товар вам не сподобався або ви
              передумали купувати.
            </div>

            <h3 className={styles.subsectionTitle}>2.2. Виняток: до отримання</h3>
            <p className={styles.textBlock}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>Псування: неприємний запах, плісень, зміна кольору</li>
              <li>Закінчився термін придатності</li>
              <li>Невідповідність складу</li>
              <li>Порушення упаковки</li>
              <li>Невідповідність кількості/ваги</li>
              <li>Сторонні включення</li>
            </ul>
            ...
            <div className={styles.greenAlert}>
              <strong>Ваші права захищені законом!</strong> Продавець не має права відмовити у
              задоволенні обґрунтованих вимог щодо товару неналежної якості.
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Повернути товар неналежної якості можна протягом 14 календарних днів з моменту отримання
              товару.
            </p>

            <h3 className={styles.subsectionTitle}>4.2. Термін для продовольчих товарів</h3>
            <p className={styles.textBlock}>
              Для продовольчих товарів рекомендується заявляти про недоліки якомога швидше:
            </p>

            <ul className={styles.list}>
              <li>Протягом 24 годин після отримання — для швидкопсувних товарів</li>
              <li>До 3 днів — для товарів із терміном придатності до 14 днів</li>
              <li>До 7 днів — для товарів із терміном придатності понад 14 днів</li>
            </ul>

            <div className={styles.orangeAlert}>
              <strong>Важливо:</strong> Чим швидше ви повідомите про недоліки, тим простіше буде
              підтвердити їх. Зберігайте товар у холодильнику!
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.stepCard}>
              ...
              <p className={styles.stepText}>
                Зробіть фото/відео товару з видимими недоліками: упаковка, термін придатності, вміст,
                накладна.
              </p>
            </div>
            ...
            <div className={styles.stepCard}>
              ...
              <p className={styles.stepText}>
                Протягом 14 календарних днів: відправимо новий товар безкоштовно або повернемо кошти на
                вашу банківську картку.
              </p>
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>Зберігати в холодильнику при температурі +2...+6°C</li>
              <li>Не використовувати більше ніж необхідно для виявлення недоліків</li>
            ...
            <div className={styles.redAlert}>
              <strong>ВАЖЛИВО:</strong> Претензії НЕ приймаються після підписання накладної без
              зауважень! Завжди перевіряйте товар при отриманні.
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ol className={styles.list}>
              ...
              <li>Подати скаргу до Держслужби з питань безпечності харчових продуктів</li>
          ...
          <div className={styles.blueAlert}>
            ...
            дотримуємося всіх вимог закону та завжди йдемо назустріч покупцям при виявленні
            обґрунтованих недоліків товару.
          </div>
        </div>
      </div>
    </div>
