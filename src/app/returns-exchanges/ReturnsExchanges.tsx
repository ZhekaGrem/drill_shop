      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <div className={styles.blueAlert}>
            ...
            захист прав споживачів», ви можете повернути непоношений мерч належної якості протягом 14 днів
            з моменту отримання. Товар неналежної якості — протягом 14 днів з моменту виявлення недоліку.
          </div>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li>Закон України &quot;Про захист прав споживачів&quot; № 1023-XII від 12.05.1991 (ст. 8, 9, 13)</li>
            ...
            <div className={styles.infoBox}>
              Мерч (футболки, худі, аксесуари) не входить до переліку товарів, що не підлягають обміну, тож
              на нього поширюється право на повернення протягом 14 днів.
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Відповідно до ст. 9 Закону України «Про захист прав споживачів», покупець має право протягом
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>
              Повернути непоношений мерч належної якості можна протягом 14 днів з моменту отримання за
              умови, що збережено заводський вигляд, етикетки та упаковку.
            </p>
