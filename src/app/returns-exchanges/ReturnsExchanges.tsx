      ...
      <Container size={900}>
        ...
        <div className={styles.content}>
          <div className={styles.redAlert}>
            <strong className={styles.boldText}>ВАЖЛИВА ІНФОРМАЦІЯ:</strong> Відповідно до Постанови Кабінету
            Міністрів України № 1769 від 19.12.1994 (зі змінами), продовольчі товари належної якості НЕ
          ...
          <section className={styles.section}>
            ...
            <p className={styles.textBlock}>Якщо товар належної якості (без дефектів), покупець НЕ МОЖЕ:</p>
            <ul className={styles.list}>
            ...
            <div className={styles.orangeAlert}>
              <strong>УВАГА:</strong> Це правило діє навіть якщо товар вам не сподобався або ви передумали
              купувати.
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.orangeAlert}>
              <strong>Важливо:</strong> Чим швидше ви повідомите про недоліки, тим простіше буде підтвердити
              їх. Зберігайте товар у холодильнику!
            </div>
          </section>
