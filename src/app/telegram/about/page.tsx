...
export const metadata = {
  title: 'Про нас | Telegram Mini App',
  description: 'Інформація про shchilnui drill shop у Telegram',
};

const TelegramAboutPage = () => {
  return (
    <>
      ...
      <Box className={styles.heroSection}>
        <Image src="/assets/img/about/hero.png" alt="Hero" fill className={styles.heroImage} priority />
      </Box>
      ...
      <Box className={styles.contentGrid}>
        <Box className={styles.textContent}>
          <Container size="lg" py={40}>
            ...
            <Text className={styles.description} mb="lg">
              Футболки наші - це не просто тряпки. Це твій щит від цього сірого світу. Одягнув - і ти вже не просто
              чувак, а той хто має стиль. Той хто не боїться бути собою серед цих всіх манекенів.
            </Text>
            <Text className={styles.description} mb="lg">
            ...
            <Text className={styles.description} mb="lg">
              Якість? Та братан, ми самі носимо це! Думаєш ми будемо якесь лайно продавати? Ні блін, ми ж не лохи.
              Кожна футболка пройшла тест-драйв у наших пацанів. Якщо витримала наші покатушки - значить годиться.
            </Text>
            <Text className={styles.description}>
              Тож якщо ти не якась маргариноська а реальний чувак шо розуміє шо до чого - то вітаємо в сім'ї. Бери
              мерч, носи з гордістю і посилай нахуй всіх хто щось там каже. Ми за своїх!
            </Text>
          </Container>
        </Box>
...
export default TelegramAboutPage;
