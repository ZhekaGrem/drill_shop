        ...
        <Box className={styles.textContent}>
          <Container size="lg" py={40}>
            ...
            <Text className={styles.description} mb="lg">
              ...
              дрільна суміш РЕПА прицепа котлети та якості. Бери в нас поки не став чімбандончиком
            </Text>
            <Text className={styles.description} mb="lg">
            ...
            <Text className={styles.description}>
              Тож якщо ти не якась маргариноська а реальний чувак шо розуміє шо до чого - то вітаємо в сімʼї.
